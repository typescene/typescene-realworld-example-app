...
export class CommentCard extends UIListCellAdapter.with(
    ...
    // comment text:
    UIFlowCell.with({ padding: { x: 24, y: 8 } }, UIRow.with(UIParagraph.withText(bind("object.body")))),
    UISeparator,
    ...
    constructor(object: ManagedObject) {
        super(object);
        this.isOwnProfile =
            !!this.userService.profile && this.userService.profile.username === this.object.author!.username;
    }
