import { bind, UICenterRow, UIColumn, UIFlowCell, UIFormContextController, UIHeading2, UILinkButton, UIOppositeRow, UIPrimaryButton, UIRow, UIScrollContainer, UISeparator, UISpacer, UITextField } from "typescene";
...
export default UIScrollContainer.with(
    ...
    UIFlowCell.with(
        ...
        // form heading:
        UICenterRow.with(
            UIHeading2.withText("Your Settings", { fontSize: 40 }),
        ),
        UISpacer.withHeight(32),

        // actual input form:
        UIFormContextController.with(
            { formContext: bind("profile") },
            UIColumn.with(
                { spacing: 16 },
                UIRow.with(
                    UITextField.with({
